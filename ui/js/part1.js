...
$(document).on('ready', function() {
	...
	$('#submit').click(function(){
		...
		var obj = 	{
						...
						personname: $('select[name="user"]').val(),
						quantity: $('input[name="quantity"]').val(),
						expensetype: $('select[name="size"]').val(),
						v: 1
					};
		console.log(obj.projectname + " : "+obj.taskname+" : "+obj.personname+" : "+obj.quantity+" : "+obj.expensetype);
		if(obj.projectname && obj.taskname && obj.personname && obj.quantity && obj.expensetype){
			console.log('creating time entry, sending', obj);
